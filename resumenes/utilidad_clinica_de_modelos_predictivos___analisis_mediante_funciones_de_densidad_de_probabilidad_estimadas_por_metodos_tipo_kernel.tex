...
\chapterprecis{Luis Mariano Esteban(1), Gerardo Sanz(2), Ángel Borque(3), José Rubio Briones(4)\\(1) Escuela Universitaria Politécnica de La Almunia, Universidad de Zaragoza.\\(2) Departamento de Métodos estadísticos, Universidad de Zaragoza.\\(3) Departamento de Urología. Hospital Universitario Miguel Servet, Zaragoza.\\(4) Departamento de Urología. Instituto Valenciano de Oncología, Valencia.}

\index{Mariano Esteban(1), Luis}
\index{Sanz(2), Gerardo}
\index{Borque(3), Ángel}
\index{Rubio Briones(4), José}

\index[inst]{(1) Escuela Universitaria Politécnica de La Almunia, Universidad de Zaragoza.}
\index[inst]{(2) Departamento de Métodos estadísticos, Universidad de Zaragoza.}
\index[inst]{(3) Departamento de Urología. Hospital Universitario Miguel Servet, Zaragoza.}
\index[inst]{(4) Departamento de Urología. Instituto Valenciano de Oncología, Valencia.}
