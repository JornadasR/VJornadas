...
\chapterprecis{Aleix Ruiz de Villa, Lluis Ramon, Andreu Vall\\TSS - Transport Simulation Systems (http://www.aimsun.com/wp/)\\RugBcn - grupo de usuarios de Barcelona (http://rugbcn.wordpress.com/)}

\index{Ruiz de Villa, Aleix}
\index{Ramon, Lluis}
\index{Vall, Andreu}

\index[inst]{TSS - Transport Simulation Systems (http://www.aimsun.com/wp/)}
\index[inst]{RugBcn - grupo de usuarios de Barcelona (http://rugbcn.wordpress.com/)}
